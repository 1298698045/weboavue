/**
 * $Id: mxDefaultToolbar.js,v 1.46 2008/06/24 16:09:28 gaudenz Exp $
 ...
 */
{
	...
	mxDefaultToolbar.prototype.drop = function(vertex, evt, target)
	{
		...
		if (target == null ||
			model.isEdge(target) ||
			!this.connectOnDrop ||
			!model.isConnectable(target))
		{
			while (target != null &&
				!graph.isValidDropTarget(target))
			{
	...
	mxDefaultToolbar.prototype.installDropHandler = function (img, dropHandler)
	{
		...
		var loader = function(evt)
		{
			...
			mxUtils.makeDraggable(img, self.editor.graph, dropHandler,
				sprite);
