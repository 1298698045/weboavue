var mxClient =
{
    ...
    IS_SVG: navigator.userAgent.indexOf('Firefox/1.5') >= 0 || navigator.userAgent.indexOf('Firefox/2') >= 0 || navigator.userAgent.indexOf('Firefox/3') >= 0 || navigator.userAgent.indexOf('Iceweasel/1.5') >= 0 || navigator.userAgent.indexOf('Iceweasel/2') >= 0 || navigator.userAgent.indexOf('Iceweasel/3') >= 0 || navigator.userAgent.indexOf('Mozilla/5') >= 0 ||navigator.userAgent.indexOf('Camino/1') >= 0 || navigator.userAgent.indexOf('Epiphany/2') >= 0 || navigator.userAgent.indexOf('Iceape/1') >= 0 || navigator.userAgent.indexOf('Galeon/2') >= 0 || navigator.userAgent.indexOf('Opera/9') >= 0 || navigator.userAgent.indexOf('Gecko/') >= 0 ||
navigator.userAgent.indexOf('AppleWebKit/5') >= 0 || navigator.userAgent.indexOf('Firefox') >= 0 || navigator.userAgent.indexOf('Mozilla/4') >= 0,
    IS_VML: (navigator.appName.toUpperCase() == 'MICROSOFT INTERNET EXPLORER' && (navigator.userAgent.indexOf('MSIE 6') >= 0 || navigator.userAgent.indexOf('MSIE 7') >= 0)),
...

{
    ...
    //jack add
    mxRectangle.prototype.participantors = "";
    mxRectangle.prototype.actvityProperties = "";
    mxRectangle.prototype.condition = "";
...
var mxUtils =
{
    ...
    getAttribute: function (node, attri, defaultValue) {

        for (var i = 0; i < node.attributes.length; i++) {
            if (node.attributes[i].nodeName == attri) {
    ...
    eval: function (expr) {
        //debugger;
        var result = null;
        if (expr.indexOf('function') >= 0 && (mxClient.IS_IE || mxClient.IS_SF || mxClient.IS_FF3 || mxClient.IS_OP || mxClient.IS_FF5)) {
            try {
...

{
    ...
    mxXmlRequest.prototype.getJson = function () {
        return this.request.responseText;
    };
...

{
    ...
    mxForm.prototype.addText = function (name, value, labelName) {
        var input = document.createElement('input');
        input.setAttribute('type', 'text');
        input.value = value;
        //@@TODO
        input.setAttribute('name', name);
        input.setAttribute('id', 'field_' + name);
        input.setAttribute("style", "height:20px;");
        return this.addField(name, input, labelName);
    };
    mxForm.prototype.addCheckbox = function (name, value, labelName) {
        var input = document.createElement('input');
        input.setAttribute('type', 'checkbox');
        input.setAttribute('id', name);
        input.setAttribute('name', name);
        this.addField(name, input, labelName);
        if (value) {
            input.checked = true;
        }
        return input;
    };
    mxForm.prototype.addTextarea = function (name, value, rows, labelName) {
    ...
    mxForm.prototype.addCombo = function (name, isMultiSelect, size, labelName) {
        ...
        return this.addField(name, select, labelName);
    };
    ...
    mxForm.prototype.addField = function (name, input,labelName) {
        var tr = document.createElement('tr');
        var td = document.createElement('td');
        if (labelName != undefined)
            mxUtils.write(td, labelName);
        else
    ...
    mxForm.prototype.createRadio = function (name, labelName,value, isSelected) {
        //@@TODO
    ...
    mxForm.prototype.addCondition = function (name, value) {
        //Condition
        var input = document.createElement('input');
        input.setAttribute('type', 'text');
        input.value = value;
        ...
        var tr = document.createElement('tr');
        var td = document.createElement('td');
        mxUtils.write(td, "Tran condition");
        tr.appendChild(td);
        td = document.createElement('td');
        td.appendChild(input);

        var selectImg = document.createElement('img');
        selectImg.src = "images/gear.gif";
        selectImg.setAttribute("alt", "Tran condition");
        selectImg.style.cursor = 'pointer';
        mxEvent.addListener(selectImg, 'click', function () {
            var wind = window.showModalDialog("/shell/Applications/FlowDesigner/ConditionDesigner.aspx");
            if (wind != null) {
                //var argument = new Argument();
                //alert(wind.content);
                input.value = wind.content;
            }
        });
    ...
    mxForm.prototype.addActivityProperties = function (name, value) {
        //Participators
        var activityProperties = new Array();
        //var actProperty = new ActivityProperty(value);
        var actProperty = value;
        //ParticipantorTypeCode
        ...
        /*
        td = document.createElement('td');
        mxUtils.write(td, mxResources.get("participantorTypeCode"));
        tr.appendChild(td);

        var lblName = "";
        var participantorTypeCode0 = false;
        var participantorTypeCode1 = false;
        var participantorTypeCode2 = false;
        if (actProperty.participantor.participantorTypeCode == 0) {
        participantorTypeCode0 = true;
        }
        if (actProperty.participantor.participantorTypeCode == 1) {
        participantorTypeCode1 = true;
        }
        if (actProperty.participantor.participantorTypeCode == 2) {
        participantorTypeCode2 = true;
        }

        td = document.createElement('td');
        
        lblName = mxResources.get("participantorTypeCode1");
        var radio = this.createRadio("participantorTypeCode", lblName, "0", participantorTypeCode0);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);

        lblName = mxResources.get("participantorTypeCode2");
        radio = this.createRadio("participantorTypeCode", lblName, "1", participantorTypeCode1);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);

        lblName = mxResources.get("participantorTypeCode3");
        radio = this.createRadio("participantorTypeCode", lblName, "2", participantorTypeCode2);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);
        ...
        */
        ...
        tr = document.createElement('tr');
        td = document.createElement('td');
        lblName = mxResources.get("mSelectType");
        mxUtils.write(td, lblName);
        tr.appendChild(td);

        //MSelectType field
        td = document.createElement('td');
        /*
        var selectTypeValue0 = false;
        var selectTypeValue1 = false;
        if (actProperty.participantor.mSelectType == 0) {
        selectTypeValue0 = true;
        }
        if (actProperty.participantor.mSelectType == 1) {
        selectTypeValue1 = true;
        }
        
        lblName = mxResources.get("mSelectType0");
        radio = this.createRadio("mSelectType", lblName, "0", selectTypeValue0);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);
        */
        //select main participator
        var input = document.createElement('input');
        input.setAttribute('type', 'text');
        input.id = "participantor";        
        if (actProperty.participantor)
            input.value = actProperty.participantor.mPeopleName;
        //input.setAttribute("readonly", true);
        input.setAttribute("style", "width:300px;height:20px;");
        td.appendChild(input);
        //id value
        input = document.createElement('input');
        input.setAttribute('type', 'hidden');
        input.id = "participantor_lkid";
        if (actProperty.participantor)
            input.value = actProperty.participantor.mValue;          
        td.appendChild(input);
        
        var selectImg = document.createElement('img');
        selectImg.src = "images/preview.gif";
        selectImg.setAttribute("alt", "delete one field");
        selectImg.style.cursor = 'pointer';
        mxEvent.addListener(selectImg, 'click', function () {
            /*
            var strparticipantors = document.getElementById("txtparticipantors").value;
            var wind = window.showModalDialog("/shell/Applications/FlowDesigner/SetParticipantors.aspx?participantors=" + encodeURIComponent(strparticipantors), "", "dialogWidth:450px;dialogHeight:500px");
            if (wind != null) {
                input.value = wind.content;
            }
            */
            openLookup('/_ui/common/data/PeoplePicker.aspx?lkfm=editPage&lknm=participantor&lktp=', 670, '1', '&lksrch=');
        });
        td.appendChild(selectImg);
        ...
        lblName = mxResources.get("mSelectType1");
        radio = this.createRadio("mSelectType", lblName, "1", selectTypeValue1);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);
        */
        //is collabration node

        lblName = mxResources.get("isCollaborationNode");
        /*
        tr = document.createElement('tr');
        td = document.createElement('td');
        ...
        */
        if (actProperty)
            var chkCollaboration = this.addCheckbox("chkCollaboration", actProperty.isCollaboration, lblName);
        else
            this.addCheckbox("chkCollaboration", false, lblName);
        //this.body.appendChild(chkCollaboration);
        /*
        td.appendChild(chkCollaboration);
        tr.appendChild(td);
        this.body.appendChild(tr);
        */
        ...
        td = document.createElement('td');
        lblName = mxResources.get("jSelectType");
        mxUtils.write(td, lblName);
        tr.appendChild(td);
        ...
        selectTypeValue0=false;
        selectTypeValue1=false;
        var selectTypeValue2=false;
        if (actProperty.participantor.jSelectType == 0) {
        selectTypeValue0=true;
        }
        if (actProperty.participantor.jSelectType == 1) {
        selectTypeValue1=true;
        }
        if (actProperty.participantor.jSelectType == 2) {
        selectTypeValue2=true;
        }

        
        lblName = mxResources.get("jSelectType0");
        radio = this.createRadio("jSelectType", lblName, "0", selectTypeValue0);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);
        
        lblName = mxResources.get("jSelectType1");
        radio = this.createRadio("jSelectType", lblName, "1", selectTypeValue1);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);
         
        lblName = mxResources.get("jSelectType2");
        radio = this.createRadio("jSelectType", lblName, "2", selectTypeValue2);
        td.appendChild(radio);
        var newtext = document.createTextNode(lblName);
        td.appendChild(newtext);
        */
        ...
        tr.appendChild(td);
        this.body.appendChild(tr);
        activityProperties.push("participantors");
        activityProperties.push(input);
        */

        //1. text editor privilege
        //        var check1 = this.addCheckbox("allowTextEditor", actProperty.allowTextEditor);
        //        activityProperties.push("allowTextEditor");
        //        activityProperties.push(check1);
        //        //2. attach file editor privilege                
        //        var check2 = this.addCheckbox("allowAttachEditor", actProperty.allowAttachEditor);
        //        activityProperties.push("allowAttachEditor");
        //        activityProperties.push(check2);

        //        //3. withdraw editor privilege
        //        var check3 = this.addCheckbox("allowBackPrevious", actProperty.allowBackPrevious);
        //        activityProperties.push("allowBackPrevious");
        //        activityProperties.push(check3);
        //        //4. cancel editor privilege
        //        var check4 = this.addCheckbox("allowCancel", actProperty.allowCancel);
        //        activityProperties.push("allowCancel");
        //        activityProperties.push(check4);
        //5.Join type      

        //        var jointype = this.addCombo("JoinType", false, 2);
        //        this.addOption(jointype, "Split", "or", true);
        //        this.addOption(jointype, "And", "and", true);

        //        activityProperties.push("jointype");
        //        activityProperties.push(jointype);
        //return input;
...

{
    ...
    mxGraphModel.prototype.createId = function (cell) {
       ...
       var objId = "";
        if (cell.vertex == 1) {
            objId = getAutoCode(2);  //活动        
        }
        else if (cell.edge) {
            objId = getAutoCode(3);  //流转        
        }
        else {
            var id = this.nextId;
            this.nextId++;
            objId = this.prefix + id + this.postfix;
        }
        return objId;
    };
...

{
    ...
    mxCellRenderer.prototype.installOverlayListeners = function (state, overlay, shape) {
        ...
        //            overlay.dispatchEvent('dblclick', overlay, evt, state.cell);
        //        });
    };
...

{
    ...
    mxGraph.prototype.scrollEventToVisible = function (evt, extend, border) {
        if (mxUtils.hasScrollbars(this.container)) {
            ...
            if (pt.x >= c.scrollLeft && pt.y >= c.scrollTop && pt.x <= c.scrollLeft + c.clientWidth && pt.y <= c.scrollTop + c.clientHeight) {
...

{
    ...
    mxEditor.prototype.dblClickAction = 'showProperties'; //@TODO
    ...
    mxEditor.prototype.propertiesWidth = 480;// 240;
            ...
            for (var i = 0; i < cells.length; i++) {
                ...
                if (self.maintainSwimlanes && graph.isSwimlane(cell)) {
                    ...
                    if (param == null || param == 0) {
                        param = (self.horizontalFlow) ? graph.container.offsetWidth - 10 :graph.container.offsetHeight;
                        param -= offset;
                    }
                ...
                for (var i = 0; i < cellCount; i++) {
                    if (graph.isSwimlane(cells[i])) {
                        ...
                        if (parent != null && visited[parentId] == null) {
                            ...
                            var param = (self.horizontalFlow) ? boundsArray[i].width :boundsArray[i].height;
                            var childCount = model.getChildCount(parent);
...
this.graph.gridSize;
    ...
    mxEditor.prototype.createProperties = function (cell) {
        ...
        if (mxUtils.isNode(value)) {
            ...
            var id = form.addText('ID', cellId);
            id.setAttribute('readonly', 'true');
            var geo = null;
            var yField = null;
            var xField = null;
            var cField = null; //jack condition
            var pField = null; //jack proerties
            var widthField = null;
            ...
            for (var i = 0; i < attrs.length; i++) {
                ...
                var tmp = attrs[i].nodeName;

                if (tmp == "label") {
                    var labelName = mxResources.get("stepName");
                    texts[i] = form.addTextarea(attrs[i].nodeName, val, (attrs[i].nodeName == 'label') ? 4 : 2, labelName);
                }
                else
            ...
            if (model.isVertex(cell)) {
                ...
                if (geo != null) {
                    ...
                    //deadline
                    var stepData = "";
                    var tmp = getWFStep(cellId);
                    if (tmp != "")
                        stepData = eval("(" + tmp + ")");

                    var labelName = mxResources.get("deadline");

                    var deadlineV = "";
                    if (stepData.deadline)
                        deadlineV = stepData.deadline
                    var deadline = form.addText('deadline', deadlineV, labelName);

                    pField = form.addActivityProperties('activityProperties', stepData);
                }
            }
            else {
                //jack
                geo = model.getGeometry(cell);
                if (geo != null) {
                    cField = form.addCondition('condition', geo.condition);
                }
            }
                ...
                try {
                    if (model.isVertex(cell)) {
                        if (geo != null) {
                            ...
                            if (j > 0)
                            str += "|";
                            var actPropertyName = pField[i];
                            var actProperty = pField[i + 1];
                            if (actProperty.type == 'checkbox')
                            str += actPropertyName + ":" + actProperty.checked;
                            else
                            str += actPropertyName + ":" + actProperty.value;
                            i++;
                            j++;
                            }
                            */
                            //geo.participantors = str;
                            //geo.activityProperties = str;
