...
function WebOffice2015() {
    ...
    this.WebGetPDFFile = function () {
        var LocalFile = ""; var RemoteFile = this.RecordID + ".pdf";
...
function KGBrowser() {
    ...
    this.openWindowBrowser = function (url, param, onlyONE) {
        ...
        link = link.replace('$link:http', '$link/http');
        setTimeout(function () {
            openUriWithInputTimeoutHack(link, function () {
