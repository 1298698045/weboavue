tinymce.addI18n("fr_FR", {
  ...
  "Open popup menu for split buttons":
    "Ouvrir le menu contextuel pour les boutons partag\u00e9s",
  ...
  "Sort table by column descending":
    "Trier le tableau par colonne en ordre d\u00e9croissant",
  Sort: "Sorte",
  Order: "Ordre",
  "Sort by": "Trier par",
  Ascending: "Ascendant",
  ...
  "Keep this ID and remove all others":
    "Conservez cet identifiant et supprimez tous les autres",
