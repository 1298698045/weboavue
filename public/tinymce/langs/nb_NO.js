tinymce.addI18n("nb_NO", {
  ...
  "The URL you entered seems to be an external link. Do you want to add the required https:// prefix?":
    "Nettadressen du fylte inn ser ut til \u00e5 v\u00e6re en ekstern. \u00d8nsker du \u00e5 legge til p\u00e5krevd 'https://'-prefiks?",
  ...
  "To open the popup, press Shift+Enter":
    "For \u00e5 \u00e5pne popup, trykk Shift+Enter",
  "Rich Text Area. Press ALT-0 for help.":
    "Rik-tekstomr\u00e5de. Trykk ALT-0 for hjelp.",
  "System Font": "Systemfont",
  "Failed to upload image: {0}": "Opplasting av bilde feilet: {0}",
  "Failed to load plugin: {0} from url {1}":
    "Kunne ikke laste tillegg: {0} from url {1}",
  ...
  "yuan character, in hong kong and taiwan":
    "yuan-symbol, i Hongkong og Taiwan",
  ...
  "Error: Form submit field collision.":
    "Feil: Skjemafelt innsendingskollisjon.",
  ...
  "Open popup menu for split buttons":
    "\u00c5pne sprettoppmeny for splitt-knapper",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "Bilder m\u00e5 markeres som dekorasjon eller ha en alternativ tekstbeskrivelse",
  "Images must have an alternative text description. Decorative images are not allowed.":
    "Bilder m\u00e5 ha en alternativ tekstbeskrivelse. Dekorasjonbilder er ikke tillatt.",
  ...
  "Keep this ID and remove all others":
    "Behold denne 'ID'-en og fjern alle andre",
