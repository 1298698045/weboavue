tinymce.addI18n("nl_BE", {
  ...
  "Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.":
    "Een id moet met een letter beginnen, gevolgd door letters, nummers, strepen, punten, dubbele punten of liggende streepjes.",
  ...
  "Save (if save plugin activated)":
    "Opslaan (als opslaan plug-in geactiveerd is)",
  "Find (if searchreplace plugin activated)":
    "Zoeken (als zoeken/vervangen plug-in geactiveerd is)",
  ...
  "Could not find the specified string.":
    "Kon de gespecificeerde string niet vinden.",
  ...
  "yuan character, in hong kong and taiwan":
    "yuan karakter, in hong kong en taiwan",
  ...
  "Error: Form submit field collision.":
    "Fout: Veldconflict bij versturen formulier.",
  ...
  "Switch to or from fullscreen mode":
    "Schakelen naar of vanuit volledige schermmodus",
  ...
  "Open popup menu for split buttons":
    "Open pop-up menu voor gesplitste knoppen",
  ...
  "Sort table by column ascending":
    "Sorteer tabel per kolom in oplopende volgorde",
  "Sort table by column descending":
    "Sorteer tabel per kolom in aflopende volgorde",
  Sort: "Sorteren",
  Order: "Ordenen",
  "Sort by": "Sorteren op",
  Ascending: "Oplopend",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "Afbeeldingen markeren als decoratief of alternatieve tekstbeschrijving geven",
  "Images must have an alternative text description. Decorative images are not allowed.":
    "Afbeeldingen moeten een alternatieve tekstbeschrijving hebben. Decoratieve afbeeldingen zijn niet toegelaten.",
  ...
  "Keep this ID and remove all others":
    "Dit ID behouden en alle andere verwijderen",
