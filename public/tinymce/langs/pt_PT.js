tinymce.addI18n("pt_PT", {
  ...
  "The URL you entered seems to be an external link. Do you want to add the required https:// prefix?":
    "O URL que introduziu parece ser uma liga\u00e7\u00e3o externa. Deseja adicionar-lhe o prefixo https:// ?",
  ...
  "No misspellings found.":
    "N\u00e3o foram encontrados erros ortogr\u00e1ficos.",
  Ignore: "Ignorar",
  ...
  "To open the popup, press Shift+Enter":
    "Para abrir o pop-up, prima Shift+Enter",
  "Rich Text Area. Press ALT-0 for help.":
    "\u00c1rea de texto formatado. Prima ALT-0 para exibir a ajuda.",
  ...
  "yuan character, in hong kong and taiwan":
    "sinal de iuane, em Hong Kong e Taiwan",
  ...
  "Error: Form submit field collision.":
    "Erro: conflito no campo de submiss\u00e3o de formul\u00e1rio.",
  ...
  "Open popup menu for split buttons":
    "Abrir o menu popup para bot\u00f5es divididos",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "As imagens devem ser marcadas como decorativas ou ter uma descri\u00e7\u00e3o textual alternativa",
  "Images must have an alternative text description. Decorative images are not allowed.":
    "As imagens devem ter uma descri\u00e7\u00e3o textual alternativa. N\u00e3o s\u00e3o permitidas imagens meramente decorativas.",
  ...
  "Keep this ID and remove all others":
    "Mantenha este ID e remova todos os outros",
