tinymce.addI18n("nl", {
  ...
  "Switch to or from fullscreen mode":
    "Overschakelen naar of vanuit de volledig scherm-modus",
  ...
  "Open popup menu for split buttons":
    "Open het pop-up menu voor gesplitste  knoppen",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "Afbeeldingen moeten als decoratief gemarkeerd zijn of moeten een alternatieve tekstbeschrijving hebben",
