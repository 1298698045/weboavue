tinymce.addI18n("cs", {
  ...
  OR: "NEBO",
  "Drop an image here":
    "P\u0159et\u00e1hn\u011bte obr\u00e1zek do tohoto um\u00edst\u011bn\u00ed",
  Upload: "Nahr\u00e1t",
  Block: "Do bloku",
  Align: "Zarovn\u00e1n\u00ed",
  Default: "V\u00fdchoz\u00ed",
  ...
  "Image is decorative":
    "(dekorativn\u00ed obr\u00e1zek bez alternativn\u00edho textu)",
  Source: "URL",
  Dimensions: "Rozm\u011bry",
  ...
  "The URL you entered seems to be an external link. Do you want to add the required https:// prefix?":
    "Zadan\u00e9 URL vypad\u00e1 jako odkaz na jin\u00fd web. Chcete doplnit povinn\u00fd prefix https://?",
  ...
  "No misspellings found.":
    "Nebyly nalezeny \u017e\u00e1dn\u00e9 p\u0159eklepy.",
  Ignore: "Ignorovat",
  ...
  "Failed to load plugin: {0} from url {1}":
    "Selhalo na\u010dten\u00ed pluginu: {0} z URL {1}",
  "Failed to load plugin url: {0}":
    "Selhalo na\u010dten\u00ed URL pluginu: {0}",
  ...
  "Open popup menu for split buttons":
    "Otev\u0159ete vyskakovac\u00ed nab\u00eddku pro rozd\u011blen\u00e1 tla\u010d\u00edtka",
  "List Properties": "Vlastnosti seznamu",
  "List properties...": "Vlastnosti seznamu...",
  "Start list at number":
    "Po\u010d\u00e1te\u010dn\u00ed \u010d\u00edslo seznamu",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "Obr\u00e1zky mus\u00ed b\u00fdt ozna\u010deny jako dekorativn\u00ed nebo mus\u00ed m\u00edt alternativn\u00ed textov\u00fd popis.",
  "Images must have an alternative text description. Decorative images are not allowed.":
    "Obr\u00e1zky mus\u00ed m\u00edt alternativn\u00ed textov\u00fd popis. Dekorativn\u00ed obr\u00e1zky nejsou povoleny.",
