tinymce.addI18n("cy", {
  ...
  "Insert link (if link plugin activated)":
    "Mewnosod dolen (os yw'r ategyn dolen yn weithredol)",
  ...
  "Error: Form submit field collision.":
    "Gwall: Gwrthdrawiad maes cyflwyno ffurflen",
  ...
  "Sort table by column descending":
    "Trefnu tabl yn \u00f4l colofn yn ddisgynnol",
  Sort: "Trefnu",
  Order: "Trefn",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "Rhaid bod delwedd wedi ei marcio yn addurniadol neu gyda disgrifiad testun arall",
  "Images must have an alternative text description. Decorative images are not allowed.":
    "Rhaid bod gan ddelwedd ddisgrifiad testun arall. Ni chaniateir delweddau addurniadol.",
