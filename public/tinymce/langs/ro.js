tinymce.addI18n("ro", {
  ...
  "Metadata and Document Properties":
    "Meta date \u0219i Propriet\u0103\u021bi Document",
  Title: "Titlu",
  ...
  "Save (if save plugin activated)":
    "Salvare (dac\u0103 modulul de salvare este activat)",
  ...
  "Failed to load plugin url: {0}":
    "Nu s-a putut \u00eenc\u0103rca URL-ul modulului: {0}",
  "Failed to initialize plugin: {0}":
    "Nu s-a putut ini\u021bializa modulul: {0}",
  example: "exemplu",
  Search: "C\u0103utare",
  All: "Tot",
  Currency: "Moned\u0103",
  ...
  "yuan character, in hong kong and taiwan":
    "simbol yuan \u00een Hong Kong \u0219i Taiwan",
  ...
  "Error: No form element found.":
    "Eroare: Niciun element de formular g\u0103sit.",
  Update: "Actualizare",
  ...
  "Switch to or from fullscreen mode":
    "Comutare pe sau de la modul ecran complet",
  ...
  "Open popup menu for split buttons":
    "Deschide\u021bi meniul pop-up pentru butoanele divizate",
  ...
  "Images must be marked as decorative or have an alternative text description":
    "Imaginile trebuie s\u0103 fie marcate ca decorative sau s\u0103 aib\u0103 o descriere alternativ\u0103 a textului",
  "Images must have an alternative text description. Decorative images are not allowed.":
    "Imaginile trebuie s\u0103 aib\u0103 o descriere alternativ\u0103 a textului. Imaginile decorative nu sunt permise.",
  ...
  "Keep this ID and remove all others":
    "P\u0103stra\u021bi acest ID \u0219i elimina\u021bi pe toate celelalte",
