tinymce.addI18n("da", {
  ...
  "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
    "Din browser underst\u00f8tter ikke direkte adgang til udklipsholder. Benyt Ctrl+X/C/ tastaturgenveje i stedet for.",
  ...
  "The URL you entered seems to be an external link. Do you want to add the required https:// prefix?":
    "URL'en som du angav ser ud til at v\u00e6re et eksternt link. \u00d8nsker du at tilf\u00f8je det n\u00f8dvendige https:// pr\u00e6fiks?",
  ...
  "To open the popup, press Shift+Enter":
    "Tryk skift + enter for at \u00e5bne pop op",
  "Rich Text Area. Press ALT-0 for help.":
    "Rich tekst omr\u00e5de. Tryk p\u00e5 ALT-0 for hj\u00e6lp.",
  "System Font": "Systemskrifttype",
  "Failed to upload image: {0}": "Mislykket billed-upload:",
  "Failed to load plugin: {0} from url {1}":
    "Mislykket plugin indl\u00e6sning: {0}  fra url {1}",
  "Failed to load plugin url: {0}":
    "Mislykket indl\u00e6sning af plugin-url: {0}",
  ...
  "Switch to or from fullscreen mode":
    "Skift til eller fra fuldsk\u00e6rmstilstand",
