<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OpenAndSave_Word.aspx.cs" Inherits="WebClient.jgfiles.samples.OpenAndSave.OpenAndSave_WordDataBase" %>
...
<head>
    ...
    <%--<script src="/jgfiles/js/WebOffice_new.js?v=1227"></script>--%>
...
<body onbeforeunload="OnUnLoad()" onunload="OnUnLoad();">
    <div style="width: 100%; height: 100%">
        ...
        <div id="OfficeDiv" style="width: 100%; height: 100%;">
            ...
            <%--<script type="text/javascript" src="../js/iWebOffice2015_new.js"></script>--%>
            <object></object>
        </div>
    </div>
