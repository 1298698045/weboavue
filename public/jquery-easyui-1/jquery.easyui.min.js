...
$.ajax({type:opts.method,url:opts.href,cache:false,headers:opts.headers,data:_27c,dataType:"html",success:function(data){
_27d(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_a9f,dataType:"json",success:function(data){
_aa0(data);
},error:function(){
