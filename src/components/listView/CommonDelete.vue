  ...
  <div>
    ...
    >
      ...
      <div class="modalContainer" ref="modelContentRef">
        <p style="text-align: center;padding: 16px 0;" v-if="props.deleteInfo.text">
          {{ props.deleteInfo.text }}
        </p>
        <slot></slot>
      </div>
      <template #footer>
...
const handleSubmit = () => {
    ...
    let d = {
        actions:[{
            ...
            params: {
                recordId: props.deleteInfo.id,
                apiName: props.deleteInfo.sObjectName,
                objTypeCode:props.deleteInfo.objTypeCode
            }
        }]
    };
    let obj = {
