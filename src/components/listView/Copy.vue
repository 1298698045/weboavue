...
<script setup>
    ...
    const handleSubmit = ()=> {
        ...
        if(data.selectList&&data.selectList.length){
            ...
            let url = Interface.listView.copyListView;
            let d = {
                actions:[{
                    id: "13165;a",
                    descriptor: "serviceComponent://ui.force.components.controllers.lists.listViewManager.ListViewManagerController/ACTION$cloneListView",
