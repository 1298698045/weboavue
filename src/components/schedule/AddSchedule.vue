                  ...
                  <div class="groupBtn">
                    <span class="icon">
                      ...
                      <Icon
                        ...
                        width="16"
                        hight="20"
                        v-if="formState.CalendarType * 1 == 0"
                      />
                      <Icon
                        name="Tag"
                        fill="rgb(14, 122, 11)"
                        width="16"
                        hight="20"
                        v-if="formState.CalendarType * 1 == 1"
                      />
                    </span>
                    <span class="text">{{ CalendarType || "日程类型" }}</span>
                    <span class="arrowIcon">
                      <DownOutlined />
                    </span>
                  </div>
                              ...
                              <a-menu>
                                ...
                                >
                                  <div
                                    class="menu-row"
                                    @click="
                                      selectOption('CalendarType', item.value)
                                    "
                                    :class="{
                                      selectOptionActive:
                                        formState.CalendarType == item.value,
  ...
  proxy.$post(Interface.pickListValues, obj).then((res) => {
    if (
      ...
      if (!props.id) {
        selectOption(
          "CalendarType",
          props.calendarType ? props.calendarType : "工作安排"
        );
      }
    }
  });
