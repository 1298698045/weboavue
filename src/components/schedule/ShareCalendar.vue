                    ...
                    <a-form :model="formState" ref="formRef">
                        ...
                        <div class="section">
                            ...
                            <div class="rowBox" v-for="(item,index) in listData" :key="index">
                                <div class="imgs">
                                    <img :src="require('@/assets/img/user/role.png')" alt="" v-if="item.ObjectType*1==1036" />
                                    <img :src="require('@/assets/img/user/group.png')" alt="" v-if="item.ObjectType*1==9" />
                                    <img :src="require('@/assets/img/user/businessunit.png')" alt="" v-if="item.ObjectType*1==10" />
                                    <img :src="require('@/assets/img/user/user.png')" alt="" v-if="item.ObjectType*1==8" />
                                </div>
                                <div class="name">
                                    {{item.ObjectName}}
                                </div>
...
<script setup>
    ...
    const getAccess = () => {
        ...
        proxy.$post(Interface.list2, {
            ...
            sort:'CreatedOn',
            order:'desc',
            displayColumns:'CalendarShareId,CreatedOn,ObjectName,SharedRights,AccessLevel,ImageUrls,ObjectType'
        }).then(res => {
            var list = [];
