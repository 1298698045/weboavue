                    ...
                    <a-form :model="formState" ref="formRef">
                                ...
                                <div class="sectionItem">
                                    <a-form-item label="搜索">
                                        <div class="menuRow">
                                                    ...
                                                    <a-menu @click="handleMenu">
                                                        <a-menu-item v-for="(item, index) in menus" :key="item.key"
                                                            ...
                                                            <span v-if="item.name == '用户'" class="share-type-img">
                                                                <img :src="require('@/assets/img/user/user.png')"
                                                                    alt="">
                                                            </span>
                                                            <span v-if="item.name == '角色'" class="share-type-img">
                                                                <img :src="require('@/assets/img/user/role.png')"
                                                                    alt="">
                                                            </span>
                                                            <span v-if="item.name == '小组'" class="share-type-img">
                                                                <img :src="require('@/assets/img/user/group.png')"
                                                                    alt="">
                                                            </span>
                                                            <span v-if="item.name == '部门'" class="share-type-img">
                                                                <img :src="require('@/assets/img/user/businessunit.png')"
                                                                    alt="">
                                                            </span>
                                                            {{ item.name }}
                                                        </a-menu-item>
                                            ...
                                            <a-select class="aselect" v-model:value="users" show-search mode="multiple"
                                                :placeholder="'搜索' + currentMenu" :default-active-first-option="false"
                                ...
                                <div class="sectionItem">
                                    <a-form-item label="访问权限">
                                        <a-select v-model:value="rightCode">
                                            ...
                                            <a-select-option value="4">允许查看和新建</a-select-option>
                        ...
                        <div class="section">
                            ...
                            <div class="rowBox" v-for="(item, index) in listData" :key="index">
                                <div class="imgs">
                                    <img :src="require('@/assets/img/user/role.png')" alt=""
                                        v-if="item.AccessObjectTypeCode * 1 == 1036 || item.AccessObjectTypeCode == '角色'" />
                                    <img :src="require('@/assets/img/user/group.png')" alt=""
                                        v-if="item.AccessObjectTypeCode * 1 == 9 || item.AccessObjectTypeCode == '小组'" />
                                    <img :src="require('@/assets/img/user/businessunit.png')" alt=""
                                        v-if="item.AccessObjectTypeCode * 1 == 10 || item.AccessObjectTypeCode == '部门'" />
                                    <img :src="require('@/assets/img/user/user.png')" alt=""
                                        v-if="item.AccessObjectTypeCode * 1 == 8 || item.AccessObjectTypeCode == '用户'" />
                                </div>
                                <div class="name">
                                    {{ item.AccessObjectName }}
                                </div>
                                <div class="option">
                                    <a-select v-model:value="item.Depth" style="width: 200px;"
                                        @change="(e) => { changeItemPerm(e, item) }">
                                        <a-select-option value="0">无权限</a-select-option>
                                        <a-select-option value="2">允许查看</a-select-option>
                                        <a-select-option value="4">允许查看和新建</a-select-option>
                                        <a-select-option value="32">管理</a-select-option>
                                ...
                                <div class="delIcon">
                                    <CloseOutlined @click="handleItemDelete(item)"
                                        v-if="item.AccessObjectId != '00000000-0000-0000-0000-000000000000' && item.AccessObjectId != '00000000-0000-0000-0000-000000000001' && item.IsCreated != 'true'" />
                                </div>
                            </div>
                        </div>
                    </a-form>
                ...
                actions: [{
                    ...
                    params: {
                        ...
                        recordInput: {
                            ...
                            objTypeCode: '6061',
                            fields: {
                                AccessObjectId: data.users[i],
                                AccessObjectName: AccessObjectName,
                                Name: AccessObjectName,
                                Depth: data.rightCode,
                                ObjectTypeName: data.currentMenu,
                                AccessObjectTypeCode: AccessObjectTypeCode,
...
const getAccess = () => {
    ...
    proxy.$post(Interface.list2, {
        ...
        sort: 'CreatedOn',
        order: 'desc',
        displayColumns: 'AccessObjectId,CreatedOn,AccessObjectName,Depth,ImageUrls,AccessObjectTypeCode'
    }).then(res => {
        var list = [];
