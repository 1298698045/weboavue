<template>
  <div class="ProjectEthicsWrap" ref="TopicsLst">
    <div class="panel" :style="{ height: height + 'px' }">
      <div class="panel-head">
        <div class="panel-title">伦理审查</div>
...
const getQuery = () => {
  ...
  // }
        proxy.$post(Interface.list2, {
            ...
            sort:'CreatedOn',
            order:'desc',
            displayColumns:'StatusCode,Name,CreatedOn,CreatedBy'
        }).then(res => {
            var list = [];
...
.peopleHeader .left .ant-picker{
  ...
  .ProjectEthicsWrap .panelt{
    background: #f0f2f6 !important;
    margin-bottom: 5px !important;
    padding: 0 !important;
  }
  .ProjectEthicsWrap .panel-top{
    background: #f0f2f6 !important;
    padding-bottom: 12px;
  }
  .ProjectEthicsWrap .panel-top .ant-card{
    border-radius: 4px !important;
  }
  .ProjectEthicsWrap .ant-card:first-child{
    margin-left: 0 !important;
  }
  .ProjectEthicsWrap .ant-card:last-child{
    margin-right: 0 !important;
  }
  .ProjectEthicsWrap .pageWrap{
    text-align: right;
    padding: 15px;
  }
  .ProjectEthicsWrap .iconBox {
  position: relative;
  cursor: pointer;
}
.ProjectEthicsWrap .popup .option-item {
  padding: 7px 15px;
  font-size: 12px;
  border-radius: 6px 6px 0 0;
}
  .ProjectEthicsWrap .iconBox .moreaction {
      padding: 0px 1px;
      width: 18px;
  ...
  .ProjectEthicsWrap .iconBox .popup{
      top: 25px;
      right: 0;
      width: max-content;
      min-width: 88px;
...
top: 1px;
  ...
  .ProjectEthicsWrap .panel-bd1{
    height: calc(~'100% - 115px') !important;
  }
  .ProjectEthicsWrap .ant-table-body{
    height: 100% !important;
  }
  .container {
      padding: 10px;
