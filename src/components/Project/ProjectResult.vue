<template>
    <div class="ProjectResultWrap" ref="TopicsLst">
      <div class="panel" :style="{ height: height + 'px' }">
        <div class="panel-head">
          <!-- <div class="panel-title">项目成果</div> -->
  ...
  const data = reactive({
    ...
    tableHeight:0,
    recordId:'',
    objectTypeCode:'20295',
    sObjectName:'ProjectPaper',
    isDelete: false,
    deleteDesc: '确定要删除吗？',
    external:false,
    CheckinStatus:null,
  ...
  const changeTabs = (e) => {
      data.activeKey = e;
      if(e==0){
        data.objectTypeCode='20295';
        data.sObjectName='ProjectPaper';
      }
      else if(e==1){
        data.objectTypeCode='20294';
        data.sObjectName='ProjectBook';
      }
      else if(e==2){
        data.objectTypeCode='20298';
        data.sObjectName='ProjectPatent';
      }
      else if(e==3){
        data.objectTypeCode='30076';
        data.sObjectName='HREmpResearchResultReward';
      }
      else if(e==4){
        data.objectTypeCode='30026';
        data.sObjectName='HREmployeeBook';
      }
  ...
  const getQuery = () => {
    ...
    // }
          proxy.$post(Interface.list2, {
              ...
              sort:'CreatedOn',
              order:'desc',
              displayColumns:'PublishDate,Name,CreatedOn,CreatedBy,'
          }).then(res => {
              var list = [];
  ...
  onMounted(() => {
    let h = document.documentElement.clientHeight;
      data.tableHeight = h-345+30;
      data.height=h-137+20;
      if(props.type=='modal'){
        data.tableHeight = h-470+30;
        data.height=h-285+20;
      }
  ...
  .peopleHeader .left .ant-picker{
    ...
    .ProjectResultWrap .panelt{
      background: #f0f2f6 !important;
      margin-bottom: 5px !important;
      padding: 0 !important;
    }
    .ProjectResultWrap .panel-top{
      background: #f0f2f6 !important;
      padding-bottom: 12px;
    }
    .ProjectResultWrap .panel-top .ant-card{
      border-radius: 4px !important;
    }
    .ProjectResultWrap .ant-card:first-child{
      margin-left: 0 !important;
    }
    .ProjectResultWrap .ant-card:last-child{
      margin-right: 0 !important;
    }
    .ProjectResultWrap .pageWrap{
      text-align: right;
      padding: 15px;
    }
    .ProjectResultWrap .iconBox {
    position: relative;
    cursor: pointer;
}
.ProjectResultWrap .popup .option-item {
    padding: 7px 15px;
    font-size: 12px;
    border-radius: 6px 6px 0 0;
}
    .ProjectResultWrap .iconBox .moreaction {
        padding: 0px 1px;
        width: 18px;
    ...
    .ProjectResultWrap .iconBox .popup{
        top: 25px;
        right: 0;
        width: max-content;
        min-width: 88px;
...
:deep .iconBox .moreaction {
  ...
  top: 1px;
    ...
    .ProjectResultWrap .panel-bd1{
      height: calc(~'100% - 115px') !important;
    }
    .ProjectResultWrap .ant-table-body{
      height: 100% !important;
    }
    .container {
        padding: 10px;
