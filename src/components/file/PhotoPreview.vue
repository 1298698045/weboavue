            ...
            <div class="d-content">
                ...
                <div class="info-box">
                    ...
                    <div class="optionLike">
                        ...
                        <div class="optionItem" @click="setLike" title="点赞" :class="{ 'active': isLike }">
                    ...
                    <div class="fileCommentBox">
                        ...
                        <div class="fileCommentListBottom">
                            ...
                            <div class="btnRow">
                                ...
                                <i v-if="false" class="iconfont icon-zan2 icon-zan3" title="点赞"></i>
                            </div>
                        </div>
                    </div>
                </div>
...
const data = reactive({
    ...
    currentUserId: '',
    rotate: 0,
    isShowCommitBtn: true,
    isLike: false,
    likeQty: 0,
    likeId: ''
})
const { likeId, isLike, likeQty, isShowCommitBtn, rotate, currentUserName, currentUserId, total, detail, currentIndex, imageList, id, items, mySwiper, commentList, comment, replyComment } = toRefs(data);
const handleClose = () => {
    emit("cancel", false);
};
                ...
                params: {
                    recordInput: {
                        ...
                        fields: {
                            ...
                            CreatedBy: data.currentUserId,
                            LikeType: 1,
                            RegardingObjectTypeCode: '100100'
                        }
                    }
                }
            }]
