<template>
    <div class="enterWrap">
        <a-tabs v-model:activeKey="activeKey">
            <a-tab-pane key="1" tab="功能开关"></a-tab-pane>
            <a-tab-pane key="2" tab="校验设置"></a-tab-pane>
            <a-tab-pane key="3" tab="开关设置"></a-tab-pane>
        </a-tabs>
        ...
        <div class="tabContent" v-else-if="activeKey==3">
            <div class="mainArea">
                <span class="main-tip">功能关闭后，app将无法使用相关功能</span>
                <div>
                    <div class="switchRoot">
                        <div class="rootl">
                            <div class="fontLabel">是否启用报销功能</div>
                            <div class="fontDesc">默认开启，支持发起报销，关闭后，不支持发起报销功能</div>
                        </div>
                        <div class="rootr">
                            <a-switch></a-switch>
                        </div>
                ...
                <div>
                    <div class="switchRoot">
                        <div class="rootl">
                            <div class="fontLabel">是否支持普通成员编辑发票</div>
                            <div class="fontDesc">默认开启，支持普通成员编辑发票。关闭后， 不支持普通成员编辑发票</div>
                        </div>
                        <div class="rootr">
                            <a-switch></a-switch>
                        </div>
                ...
                <div>
                    <div class="switchRoot">
                        <div class="rootl">
                            <div class="fontLabel">是否开启共享人的人力资源组件</div>
                            <div class="fontDesc">默认关闭，只支持搜索用户，不支持人力资源组件选人。开启后支持人力资源组件选人</div>
                        </div>
                        <div class="rootr">
                            <a-switch></a-switch>
                        </div>
                ...
                <div>
                    <div class="switchRoot">
                        <div class="rootl">
                            <div class="fontLabel">定额发票启用开票日期</div>
                            <div class="fontDesc">默认关闭，关闭时没有开票日期，开启后则将获取发票的录入时间作为发票的开票日期</div>
                        </div>
                        <div class="rootr">
                            <a-switch></a-switch>
                        </div>
