                ...
                <div class="tabList-wrapper">
                    <div class="tabContainer flex">
                        <div class="tabList">
                            ...
                            }" v-for="(tab, tabIdx) in tabs" @click="handleItemTab(item, tabIdx)">
                                <div class="tabHover">
                                    <span class="tabText">
                                        {{ tab.label }}
                                        <span class="tabnum">{{
                                    ...
                                    deleteTabListTag(item, tab, tabIdx)
                                  ">
        ...
        <template  v-if="themeType=='default'">
            <div class="item-default-header">
                ...
                <div class="titlecontainer">
                    <div class="rc-tabs">
                        <div class="rc-tabs-tab" :class="{active: current == tabIdx }" v-for="(tab, tabIdx) in tabs" @click.stop="handleItemTab(tab, tabIdx)">
                            <div class="tab2" style="width: auto; vertical-align: top; background-size: 100% 100%; height: 32px; line-height: 32px; padding-top: 0px; position: relative;">
                                <div style="width: 76px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; display: inline-block;">{{ tab.label }}</div>
            ...
            <div class="dashGridItem">
                ...
                <div class="tabs_default query-builder-widget-tab">
                    <ul class="fh-tabs_default__nav">
                        <li class="fh-tabs_default__item" :class="{ active: current == tabIdx }" v-for="(tab, tabIdx) in tabs" @click.stop="handleItemTab(tab, tabIdx)">
...
<script setup>
    ...
    const { tabs, current, columns, properties, tableData } = toRefs(data);
