        ...
        <template v-if="themeType=='default'">
            <div class="item-default-header">
                ...
                <div class="titlecontainer">
                    <div class="rc-tabs">
                        <div class="rc-tabs-tab" :class="{active: current == tabIdx }" v-for="(tab, tabIdx) in tabs"
                            @click.stop="handleItemTab(tab, tabIdx)">
                            <div class="tab2"
                ...
                <div class="tabs_default query-builder-widget-tab">
                    <ul class="fh-tabs_default__nav">
                        <li class="fh-tabs_default__item" :class="{ active: current == tabIdx }"
                            v-for="(tab, tabIdx) in tabs" @click.stop="handleItemTab(tab, tabIdx)">
