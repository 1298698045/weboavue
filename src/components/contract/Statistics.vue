            ...
            <div class="rowCard">
                <a-card :bordered="false">
                    <div class="cardHead">
                        ...
                        <span class="icon" @click="handleMax">
                            <ArrowsAltOutlined />
                        </span>
                    </div>
                    <div class="cardBd">
                        <div class="ditigal-data">
                            <div class="ditigal-data-text">
                                {{ fields.TotalPrice && fields.TotalPrice.value ? fields.TotalPrice.value : 0 }}</div>
                            <div class="ditigal-data-unit">元</div>
                        </div>
                        <div class="extra">
                            <div>
                                <span><span class="number-text">同比</span><span class="ml8 number">14%</span></span>
                                <span><i class="rpicon rpicon-caret-up"
                                        style="color: rgb(245, 34, 45); font-size: 12px; transform: scale(0.83); margin-left: 5px;"></i></span>
                            </div>
                            <div>
                                <span><span class="number-text">同比</span><span class="ml8 number">14%</span></span>
                                <span><i class="rpicon rpicon-caret-up"
                ...
                <a-card :bordered="false">
                    ...
                    <div class="cardBd">
                        <div class="ditigal-data">
                            <div class="ditigal-data-text">
                                {{ fields.PaidAmount && fields.PaidAmount.value ? fields.PaidAmount.value : 0 }}</div>
                            <div class="ditigal-data-unit">元</div>
                        </div>
                        <div class="extra">
                            <div>
                ...
                <a-card :bordered="false">
                    ...
                    <div class="cardBd">
                        <div class="ditigal-data">
                            <div class="ditigal-data-text">
                                {{ fields.UnpaidAmount && fields.UnpaidAmount.value ? fields.UnpaidAmount.value : 0 }}
                            </div>
                            <div class="ditigal-data-unit">元</div>
                        </div>
                        <div class="extra">
                ...
                <a-card :bordered="false">
                    <div class="cardHead">
                        <span class="title">合同完成进度</span>
                        <span class="icon">
                            <ArrowsAltOutlined />
                        </span>
                    </div>
                    <div class="cardBd">
                        <Gauge className="chart" v-if="isShow"
                            :chartValue="(fields.PaymentPercentage && fields.PaymentPercentage.value ? fields.PaymentPercentage.value * 1 : 0)">
                        </Gauge>
                    </div>
                </a-card>
            </div>
        ...
        <div class="center" v-else>
            <div class="rowCard" style="height: 100%;">
                <a-card class="w100" :bordered="false">
                    <div class="cardHead">
                        <span class="title">总金额</span>
                        <span class="icon" @click="data.isMax = false">
                            <ArrowsAltOutlined />
                        </span>
                    </div>
                    <div class="cardBd">
...
const { isShow, fields, isCollapsed, tableHeight, fieldNames, tabs, activeKey, searchVal,
...
onMounted(() => {
    if (props.fields && props.fields.Title) {
