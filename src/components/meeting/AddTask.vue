              ...
              <div class="groupContainer">
                  ...
                  <template #overlay>
                    <a-menu>
                      ...
                      >
                        <div
                          class="menu-row"
                          @click="selectOption('Reply', item.value)"
                          :class="{
                            selectOptionActive: formState.Reply == item.value,
                          }"
                        >
                          <span class="icon">
                ...
                <a-dropdown>
                  ...
                  <template #overlay>
                    <a-menu>
                      <a-menu-item
                        v-for="(item, index) in DisplayStatusList"
                        :key="index"
                      >
                        <div
                          class="menu-row"
                          @click="selectOption('DisplayStatus', item.value)"
                        >
                          <span class="icon DisplayStatusIcon">
                            <i
                              data-icon-name="ShowAsFreeIcon"
                              aria-hidden="true"
                              class="icon-520"
                              v-if="item.value * 1 == 1"
                            >
                            ...
                            <i
                              data-icon-name="ShowAsWorkingElsewhereIcon"
                              aria-hidden="true"
                              class="icon-507"
                              v-if="item.value * 1 == 2"
                            >
                            ...
                            <i
                              data-icon-name="ShowAsTentativeIcon"
                              aria-hidden="true"
                              class="icon-507"
                              v-if="item.value * 1 == 3"
                            >
                            ...
                            >
                              <div
                                ...
                                style="
                                  ...
                                  border-color: rgba(180, 0, 158, 0.9);
                ...
                <a-dropdown>
                  ...
                  <template #overlay>
                    <a-menu>
                      <a-menu-item
                        v-for="(item, index) in ReminderTimeList"
                        :key="index"
                      >
                        <div
                          class="menu-row"
                          @click="selectOption('ReminderTime', item.value)"
                          :class="{
                            selectOptionActive:
                              formState.ReminderTime == item.value,
                          }"
                        >
                          <span class="icon">
                            <template
                              v-if="formState.ReminderTime == item.value"
                            >
                              <CheckOutlined />
                            </template>
                          </span>
                  ...
                  <div class="groupBtn">
                    <span class="icon">
                      ...
                      <Icon
                        ...
                        width="16"
                        hight="20"
                        v-if="formState.CalendarType * 1 == '工作安排'"
                      />
                      <Icon
                        name="Tag"
                        fill="rgb(14, 122, 11)"
                        width="16"
                        hight="20"
                        v-if="formState.CalendarType * 1 == '个人'"
                      />
                    </span>
                  ...
                  <template #overlay>
                    <a-menu>
                      ...
                      >
                        <div
                          class="menu-row"
                          @click="selectOption('CalendarType', item.value)"
                          :class="{
                            selectOptionActive:
                              formState.CalendarType == item.value,
                          }"
                        >
                          <span class="icon">
                            <template
                              v-if="formState.CalendarType == item.value"
                            >
                              <CheckOutlined />
                            </template>
                          </span>
                ...
                <div
                  class="groupBtn"
                  @click="formState.IsPrivate = !formState.IsPrivate"
                >
                    ...
                    <div class="formRow">
                      ...
                      <div class="rVal">
                        ...
                        >
                          ...
                          <a-select-option
                            v-for="(option, optionIdx) in OwningUser"
                            :key="optionIdx"
                            :value="option.ID"
                          >
                            <a-avatar :size="37">
                        ...
                        <div class="groupContainer">
                          <a-dropdown>
                            ...
                            <template #overlay>
                              <a-menu>
                                <a-menu-item
                                  v-for="(item, index) in RecurrenceTypeList"
                                  :key="index"
                                >
                                  <div
                                    class="menu-row"
                                    @click="
                                      selectOption('RecurrenceType', item.value)
                                    "
                                    :class="{
                                      selectOptionActive:
                                        formState.RecurrenceType == item.value,
                                    }"
                                  >
                                    <span class="icon">
                                      <template
                    ...
                    <div class="formRow">
                      ...
                      <div class="rVal rValRegardingObjectId">
                        ...
                        >
                          <template #suffixIcon></template>
                          <a-select-option
                            v-for="(option, optionIdx) in RegardingObjectId"
                            :key="optionIdx"
                            :value="option.ID"
                          >
                            <!-- <a-avatar :size="37">
...
const getDetail = () => {
  ...
  proxy.$post(Interface.detail, obj).then((res) => {
    if (
      ...
      selectOption(
        "DisplayStatus",
        fields.DisplayStatus ? fields.DisplayStatus.value : ""
      );
      selectOption(
        "ReminderTime",
        fields.ReminderTime ? fields.ReminderTime.value : ""
      );
      selectOption(
        "CalendarType",
        fields.CalendarType ? fields.CalendarType.value : ""
      );
      selectOption(
        "RecurrenceType",
        fields.RecurrenceType ? fields.RecurrenceType.value : ""
      );
      formState.IsPrivate =
        fields.IsPrivate && fields.IsPrivate.value
          ? fields.IsPrivate.value
          : false;

      formState.Location =
        fields.Location && fields.Location.value ? fields.Location.value : "";
      formState.Subject =
        fields.Subject && fields.Subject.value ? fields.Subject.value : "";
      ...
      formState.StartDateTime =
        fields.ScheduledStart && fields.ScheduledStart.value
          ? dayjs(fields.ScheduledStart.value).format("YYYY-MM-DD")
          : "";
      formState.StartDateTime_time =
        fields.ScheduledStart && fields.ScheduledStart.value
          ? dayjs(fields.ScheduledStart.value).format("HH:mm")
          : "";
      formState.EndDateTime =
        fields.ScheduledEnd && fields.ScheduledEnd.value
          ? dayjs(fields.ScheduledEnd.value).format("YYYY-MM-DD")
          : "";
      formState.EndDateTime_time =
        fields.ScheduledEnd && fields.ScheduledEnd.value
          ? dayjs(fields.ScheduledEnd.value).format("HH:mm")
          : "";
      ...
      if (fields.RegardingObjectId && fields.RegardingObjectId.value) {
        ...
        formState.RegardingObjectIdName =
          RegardingObjectIdName ||
          (RegardingObjectIdValue == props.RegardingObjectId
            ? props.RegardingObjectIdName
            : "");
      ...
      formState.RegardingObjectTypeCode =
        fields.RegardingObjectTypeCode.value || "";
...
const handleSubmit = () => {
  ...
  if (
    ...
    formState.OwningUser.Id &&
    formState.OwningUser.Id.length
  ) {
  } else {
    message.error("被分配人不能为空。");
    return;
  }
  if (formState.RegardingObjectId && formState.RegardingObjectId.Id) {
  } else {
      ...
      if (props.id) {
        ...
        if (props.RegardingObjectId) {
          ...
          d.actions[0].params.recordInput.fields.RegardingObjectId =
            formState.RegardingObjectId.Id || props.RegardingObjectId;
          d.actions[0].params.recordInput.fields.RegardingObjectIdName =
            formState.RegardingObjectIdName || props.RegardingObjectIdName;
...
.DisplayStatusIcon {
  ...
  .f7wT9 {
    background-image: linear-gradient(
      ...
      linear-gradient(45deg, #ffffff 38%, transparent 38%),
      linear-gradient(45deg, #ffffff 38%, transparent 38%);
