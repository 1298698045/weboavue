  ...
  <div class="MeetingSummaryWrap" ref="TopicsLst">
    <div class="panel" :style="{ height: height + 'px' }">
      <div class="panel-head">
        ...
        <div class="panel-btn">
          <a-button class="ml10" type="primary" @click="handleEdit"
            >编辑</a-button
          >
          <a-button class="ml10" @click="handleView">预览</a-button>
        </div>
      </div>
      <div class="panel-bd MeetingSummaryContent" v-html="content"></div>
    </div>
    <radio-user
      v-if="isRadioUser"
      :isShow="isRadioUser"
    ...
    <NewInfo
      ...
      :FolderId="'00000000-0000-0000-0000-000000002000'"
      :RegardingObjectName="props.RegardingObjectName"
    />
  </div>
</template>
<script setup>
...
const handleEdit = (key) => {
  window.open(
    "/#/content/visualEditor?id=" +
      data.recordId +
      "&objectTypeCode=100201&FolderId=00000000-0000-0000-0000-000000002000&RegardingObjectTypeCode=5000&RegardingObjectId=" +
      props.id
  );
  //data.isCommon = true;
};
...
const handleView = (id) => {
  ...
  window.open(
    "/#/previewContent?id=" + data.recordId + "&objectTypeCode=100201"
  );
};
onMounted(() => {
