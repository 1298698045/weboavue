  ...
  <div ref="modelContentRef">
      ...
      :style="setTop"
          ...
          <div class="modalContainer scheduleModalContainer" :style="{ height: height + 'px' }">
              <ScheduleDetailContent :itemid="props.id" :title="title" :RegardingObjectIdName="props.RegardingObjectIdName" @handleDelete="handleDelete" @close="handleCancel" @reload="handleSubmit" />
          </div>
          <template #footer>
              <div>
