<template>
  <div class="TopicsWrap" ref="TopicsLst">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td colspan="2" class="righttd">
                  <div style="min-height: 80px;" v-html="detailData.Description ? detailData.Description.value : ''">
                  </div>
                </td>
              </tr>
              <tr>
    ...
    <AddTopic v-if="isAddTopic" :isShow="isAddTopic" @select="handleSelectTopic" :entityApiName="sObjectName"
      @cancel="isAddTopic = false" />
  </div>
</template>
<script setup>
