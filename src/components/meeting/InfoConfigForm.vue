              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <a-form-item
                      :name="attribute.targetValue"
                      v-else-if="attribute.attributes.type == 'X'||attribute.attributes.type == 'z'||attribute.attributes.type == 'J'"
                      :label="attribute.label"
                      :rules="[
                        {
                          required: attribute.attributes.required,
    ...
    data.layoutList.forEach(item=>{
      item.rows.forEach(row=>{
        row.attributes.forEach(col=>{
          formState[col.localId] = data.list[col.localId]?data.list[col.localId].value:'';
          ...
          if(col.attributes.type=='F' && col.localId=='ScheduledStart' && props.paramsTime && props.paramsTime.date && !props.id){
                          ...
                          }else if(col.attributes.type=='F' && col.localId=='ScheduledEnd'&& props.paramsTime  && props.paramsTime.date && !props.id){
                              if(props.paramsTime.date && props.paramsTime.time=='') {
                          ...
                          }else if(col.attributes.type=='F' && col.localId=='ScheduledStart' && props.id&& props.paramsTime ){
                              if(data.list[col.localId]&&data.list[col.localId].value) {
                                  formState[col.localId] = data.list[col.localId].value;
                                  formState[col.localId+'_obj'] = {
                                      date: dayjs(data.list[col.localId].value).format("YYYY-MM-DD"),
                                      time: dayjs(data.list[col.localId].value).format("HH:mm")
                                  }
                              }else if(props.paramsTime.date && props.paramsTime.time=='') {
                                  formState[col.localId] = props.paramsTime.date + ' 08:00';
                                  formState[col.localId+'_obj'] = {
                          ...
                          }else if(col.attributes.type=='F' && col.localId=='ScheduledEnd' && props.id&& props.paramsTime ){
                              if(data.list[col.localId]&&data.list[col.localId].value) {
                                  formState[col.localId] = data.list[col.localId].value;
                                  formState[col.localId+'_obj'] = {
                                      date: dayjs(data.list[col.localId].value).format("YYYY-MM-DD"),
