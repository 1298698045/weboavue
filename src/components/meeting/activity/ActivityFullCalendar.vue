<template>
  <div class="ActivityFullCalendarWrap">
    <div ref="ActivityFullCalendarRef">
      <FullCalendar
        class="fullCalendar"
        ref="fullCalendarRef"
...
const ActivityFullCalendarRef = ref(null);
const fullCalendarRef = ref(null);
onMounted(() => {
  data.height = ActivityFullCalendarRef.value.scrollHeight;
