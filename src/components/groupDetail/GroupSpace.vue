<template>
    <div class="GroupSpace">
        <div class="panel">
            ...
            <div class="panel-bd">
                <TEditor :placeholder="'有什么新鲜事想分享给大家?'" @input="getInputContent" />
                <div class="sendWrap">
