            ...
            <div class="panel-bd">
                <div class="abstract">
                    ...
                    <div class="abstractItem">
                        ...
                        <div class="abstractItem-num">{{statistics.TotalContentLike}}</div>
                    </div>
                    <div class="abstractItem">
...
<script setup>
    ...
    import { ref, toRefs, reactive, toRaw, onMounted, watch, getCurrentInstance, nextTick, onUnmounted } from "vue";
    ...
    const loadChart = () => {
        ...
        var chartName = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'];
        var myChart;
