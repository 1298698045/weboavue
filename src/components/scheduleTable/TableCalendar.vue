    ...
    <div class="calendarWrap">
        <div class="rightBox">
            ...
            <div class="calendarBody" ref="contentRef" v-if="showComponent">
                ...
                <TableFullCalendar v-if="showComponent" ref="FullCalendarWrap" :calendarView="calendarView" :id="id"
        ...
        <AddSchedule :isShow="isAddSchedule" :id="id" v-if="isAddSchedule" :paramsTime="paramsTime"
            @cancel="cancelAddSchedule" :objectTypeCode="objectTypeCode" :entityApiName="sObjectName"
            @selectVal="handleNewScheduleVal" :calendarType="formState.type" />
        ...
        <ScheduleDetailModal :isShow="isScheduleDetail" v-if="isScheduleDetail" :id="id"
            @cancel="isScheduleDetail = false" @selectVal="handleNewScheduleVal" @handleDelete="handleDelete"
            @edit="handleOpenEdit" />
        <Delete v-if="isDelete" :isShow="isDelete" :desc="deleteDesc" @cancel="cancelDelete" @ok="onSearch"
