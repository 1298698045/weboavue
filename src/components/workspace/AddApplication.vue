<template>
  <div class="appcenter-common-app-modal">
    <div
      class="larkc-modall-wrapper larkc-modall-wrapper-mask content-center"
      v-if="isModal"
    >
      <div
        class="larkc-modall-wrapper larkc-modall-wrapper-mask content-center"
      ...
      <div class="larkc-modall-content">
        <div
          class="appcenter-common-app-modal larkc-modall larkc-modall-middle"
        >
                ...
                <div class="appcenter-common-app-body">
                  <div class="app-list">
                    <div class="app-search-container">
                      <svg
                        class="larkc-svg-icon app-search-icon"
                        aria-hidden="true"
                        ...
                        <div class="scroller_content">
                          ...
                          <div class="list_items">
                            ...
                            >
                              ...
                              <div
                                class="larkc-checkbox app-list-checkbox"
                                :class="{
                                  'larkc-checkbox-checked': item.isChecked,
                                }"
                              >
                                <svg
                                  class="larkc-svg-icon larkc-checkbox-icon"
                                  v-if="item.isChecked"
                                  aria-hidden="true"
                                  viewBox="0 0 1024 1024"
                                >
                  ...
                  <div class="app-selected">
                    <div class="app-selected-info">
                      <div class="app-selected-info-left">
                        已选：{{ selectData.length }}
                      </div>
                    ...
                    <div class="app-selected-list">
                      <div
                        ...
                        :key="index"
                      >
                        <div class="larkc-avatar larkc-avatar-small app-avatar">
                          <img
                            class="larkc-avatar-img"
                            alt="Avatar"
                            :src="getImagePath(item.PictureUrl)"
...
const handleSubmit = () => {
  ...
  for (var i = 0; i < data.selectData.length; i++) {
    ...
    if (data.selectData[i].id) {
      d.actions[0].params.recordId = data.selectData[i].id;
      url = Interface.edit;
    }
    let obj = {
