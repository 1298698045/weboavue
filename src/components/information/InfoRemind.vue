            ...
            <a-form :model="formState" ref="formRef">
              <div class="section">
                ...
                <div class="sectionRow">
                    <div class="sectionItem">
                        <div class="row">
                            <a-checkbox v-model:checked="checked">短信</a-checkbox>
                        </div>
                        <div class="row">
                            <a-checkbox v-model:checked="checked">发送APP</a-checkbox>
                        </div>
                        <div class="row">
                            <a-checkbox v-model:checked="checked">发送邮件</a-checkbox>
                        </div>
                        <div class="row">
                            <a-checkbox v-model:checked="checked">重复提醒</a-checkbox>
                        </div>
                    </div>
                </div>
              </div>
