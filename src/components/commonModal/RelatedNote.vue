<template>
  <div>
    <a-modal v-model:open="props.isShow" width="850px" :maskClosable="false" @cancel="handleCancel" @ok="handleSubmit">
      ...
      <div class="modalContainer RelatedNoteWrap">
        <div class="modalCenter" :style="{ height: height + 'px' }">
          <a-form :model="formState" ref="formRef">
            <div class="section">
              ...
              <div class="sectionRow NotRequired">
                <div class="sectionItem">
                  <a-form-item label="私有" name="IsPrivate">
                    <!-- <a-checkbox
                      v-model:checked="formState.IsPrivate"
                    ></a-checkbox> -->
                    <a-switch v-model:checked="formState.IsPrivate" class="switchItem" />
                  </a-form-item>
                </div>
              </div>
              <div class="sectionRow">
                <div class="sectionItem">
                  <a-form-item label="备注" name="Body" :rules="[
                    {
                      required: true,
                      message: '请输入备注',
                    },
