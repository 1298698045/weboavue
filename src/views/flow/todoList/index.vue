  ...
  <div class="todoList">
    <div class="headerBar todo-head">
      <div class="headerLeft">
        ...
        <span class="headerTitle">待办事宜</span>
      </div>
      <div class="headerRight todo-head-right">
        ...
        <MoreBtn :isMenu="isMenu" @click="isMenu = true" @mouseleave="isMenu = false">
          <div class="moreMenu">
        ...
        <a-col span="5" class="wea-left-right-layout-left" v-if="!isCollapsed">
          <div class="wea-left-tree">
            ...
            <div class="wea-left-tree-scroll processTree">
              <a-tree :style="{ height: tableHeight - 10 + 'px' }" :expanded-keys="expandedKeys"
                ...
                <template #switcherIcon="{ switcherCls }">
                  <CaretDownOutlined :class="switcherCls" style="
    ...
    <Delete :isShow="isDelete" :desc="deleteDesc" @cancel="isDelete = false" @ok="handleSearch"
      :sObjectName="data.queryParams.entityName" :recordId="ProcessInstanceId"
      :objTypeCode="data.queryParams.objectTypeCode" :external="false" />
    <!-- 撤销、结束、取消督办、取消收藏 -->
    <CommonConfirm v-if="isConfirm" :isShow="isConfirm" :text="confirmText" :title="confirmTitle"
      @cancel="isConfirm = false" @ok="isConfirm = false" :id="ProcessInstanceId" />
    <!-- 传阅 -->
    ...
    <Supervised v-if="isSupervised" :isShow="isSupervised" @cancel="isSupervised = false"
      @update-status="isSupervised = false" :id="ProcessInstanceId" :name="processName" />
    <!-- 收藏 -->
    ...
    <export-field :isShow="isExportModal" v-if="isExportModal" @cancel="isExportModal=false"
      :sObjectName="data.queryParams.entityName" :recordId="data.queryParams.filterId" :search="data.queryParams.search"
      :filterCondition="data.queryParams.filterCondition"></export-field>
  </div>
</template>
<script setup>
  import {
              ...
              columnslist.push({
                ...
                formatter: function formatter(value, row, index) {
                  ...
                  return (
                    ...
                    ProcessInstanceId +
                    '&reurl=/lightning/o/workflow/doing" target="_blank">' +
                    result +
                    "</a>"
                  );
                },
  ...
  const batchPrintForm = () => {
    ...
    if (list.length) {
      ...
      localStorage.setItem("batchPrintIds", processInstanceIds.join(','));
      let url = router.resolve({
