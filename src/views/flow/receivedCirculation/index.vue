        ...
        if (item.name == 'Name') {
          columnslist.push({
            ...
            formatter: function formatter(value, row, index) {
              ...
              return '<a class="namefield" title="' + result + '" href="/#/lightning/r/Workflow/instance/view?id=' + ProcessInstanceId + '&reurl=/lightning/o/workflow/doing" target="_blank">' + result + '</a>';
            }
          });
        }
        else {
...
watch(() => route, (newVal, oldVal) => {
  if (gridRef && gridRef.value && gridRef.value.loadGrid != 'undefined' && !route.params.sObjectName) {
    if (route.path == '/lightning/page/workflow/forward/home') {
      //getTreeData();
      data.queryParams = {
        filterId: '',
        objectTypeCode: '147',
      ...
      data.entityType = '147';
      data.layoutName = 'WFInstanceForward'
      setTimeout(function () {
        getTabs();
      }, 1000)
    }
