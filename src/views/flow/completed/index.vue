  ...
  <div class="todoList">
    <div class="headerBar todo-head">
      <div class="headerLeft">
        ...
        <span class="headerTitle">已办事宜</span>
      </div>
  ...
  },
  {
    ...
    formatter: function formatter(value, row, index) {
      ...
      var str = `
            ...
            <div class="option-item" onclick="Processtoreload('${ProcessInstanceId}')">重办</div>
        ...
        if (item.name == 'Name') {
          columnslist.push({
            ...
            formatter: function formatter(value, row, index) {
              ...
              let id = row.id;
              return '<a class="namefield" title="' + result + '" href="/#/lightning/r/Workflow/instance/detail?id=' + id + '&print=1' + '&reurl=/lightning/o/workflow/done/list" target="_blank">' + result + '</a>';
            }
          });
        }
        else {
