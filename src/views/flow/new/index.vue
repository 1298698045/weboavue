        ...
        <div class="newFlowWrap">
          ...
          <div class="flowContainer">
            <div class="flowTypes">
              ...
              <a
                class="flowTypeItem"
                :class="{ active: typeIndex === item.categoryId }"
            ...
            <div class="flowContent">
              <template v-for="(item, index) in processLists" :key="index">
                <div
                  ...
                  v-if="
                    (typeIndex == item.categoryId || typeIndex == '') &&
                    item.Processes &&
                ...
                >
                  ...
                  <div class="flowPanelItemBd">
                    <div
                      class="flowRowItem"
                      v-for="(row, idx) in item.Processes"
                      :key="idx"
                    ...
                    >
                      ...
                      <div
                        class="collectionIcon"
                        @click.stop="handleBatchStartProcess(row)"
                      >
                        <a-tooltip :overlayClassName="'flowRowItem-tooltip'">
...
import FlowNew from "@/components/workflow/FlowNew.vue";
    ...
    if (
      ...
      for (var i = 0; i < res.actions[0].returnValue.rows.length; i++) {
        ...
        if (item && item.name && item.name.indexOf(data.searchVal) != -1) {
          ...
          if (!isHasFolder) {
            data.processLists[data.processLists.length - 1].Processes.push(
              item
            );
          }
        }
