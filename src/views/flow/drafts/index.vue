<template>
    <div class="todoList">
            ...
            <a-row>
                ...
                <a-col :span="isCollapsed ? '24' : '19'" class="wea-left-right-layout-right">
                    ...
                    <a-button class="ml10">批量取消发布</a-button> -->
                        ...
                        <list-form-search ref="searchRef" @search="handleSearch"
                            :entityApiName="data.queryParams.entityName" :SearchFields="SearchFields"
        ...
        <!-- 删除 -->
        <Delete :isShow="isDelete" :desc="deleteDesc" @cancel="isDelete=false" @ok="deleteFlow"
            :sObjectName="data.queryParams.entityName" :recordId="ProcessInstanceId"
            :objTypeCode="data.queryParams.objectTypeCode" :external="true" />
        <!-- 撤销、结束、取消督办、取消收藏 -->
        ...
        },
        {
            ...
            formatter: function formatter(value, row, index) {
                ...
                var str = `
                  <div class="iconBox">
              <div class="popup">
              <div class="option-item" onclick="handleEdit('${ruleLogId}')">编辑</div>
                    ...
                    if (item.name == 'Name') {
                        columnslist.push({
                            ...
                            formatter: function formatter(value, row, index) {
                                ...
                                return '<a style="color:#1677ff;text-decoration: none;" href="/#/lightning/r/Workflow/instance/detail?id=' + ProcessInstanceId + '&reurl=/lightning/o/workflow/doing" target="_blank">' + result + '</a>';
                            }
                        });
                    }
                    else {
