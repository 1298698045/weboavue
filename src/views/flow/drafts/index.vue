                ...
                if (item.name == 'Name') {
                    columnslist.push({
                        ...
                        formatter: function formatter(value, row, index) {
                            ...
                            return '<a class="namefield" title="' + result + '" href="/#/lightning/r/Workflow/instance/detail?id=' + ProcessInstanceId + '&reurl=/lightning/o/workflow/doing" target="_blank">' + result + '</a>';
                        }
                    });
                }
                else {
