...
.FollowWrap {
  .todo-content .ant-row .wea-left-right-layout-left .wea-left-tree .wea-left-tree-search .wea-left-tree-search-label {
    padding-left: 0;
    min-width: 62px;
  }
  ...
  .todo-content .ant-row .wea-left-right-layout-left .wea-left-tree .wea-left-tree-scroll {
    padding-top: 8px;
