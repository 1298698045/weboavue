        ...
        <div class="mainContent">
            <div class="leftContent">
                <div class="panel panel0">
                    ...
                    <div class="panel-bd">
                        <div class="left-menu">
                            <div class="left-menu-item" :class="{ 'left-menu-item-active': data.selectmenu == 1 }"
                                @click="changeMenu(1)">
                                <span class="left-menu-item-icon">
                                    <BarsOutlined />
                                </span><span class="left-menu-item-label">全部状态</span>
                            </div>
                            <div class="left-menu-item" :class="{ 'left-menu-item-active': data.selectmenu == 2 }"
                                @click="changeMenu(2)">
                                <span class="left-menu-item-icon">
                                    <UserOutlined />
                                </span><span class="left-menu-item-label">我的状态</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panelCommunityCommentWrap">
                            <div class="commentBox commentBox0">
                                ...
                                <div class="TEditorWrap CommentWrap" v-if="activeKey == '6000' || activeKey == '0'">
                                    ...
                                    <a-textarea class="Votetextarea" v-model:value="data.text"
                                        placeholder="有什么新鲜事想分享给大家？" :rows="6"></a-textarea>
                                    ...
                                    <a-dropdown class="optionalDropdown">
                                        <div class="show">
                                            ...
                                            <span class="arrowIcon">
                                                <!-- <DownOutlined /> -->
                                                <svg class="moreaction" width="12" height="16" viewBox="0 0 520 520"
                                        ...
                                        <template #overlay>
                                            <a-menu>
                                                <a-menu-item v-for="(item, index) in submitTypeList" :key="index">
                                                    <div class="menu-row"
                                                        @click="selectOption('submitType', item.value)"
                        ...
                        <div class="panelCommunityCommentWrap">
                            <div class="commentSearch">
                                <div class="wea-left-tree-search">
                                    <a-input v-model:value="searchVal" placeholder="搜索状态" @change="onSearch"
                                        allowClear />
                                        ...
                                        <div class="commentContent" v-if="activeKey == '0'" @click="handleDetail(item)">
                                            ...
                                            <div class="commentContentItem picturesList" v-if="item.pictures.length">
                                                <img v-for="(ite, idx) in item.pictures" :key="idx" :src="ite.viewUrl"
                                                    class="img" @click.stop="handlePreviewImg(ite, idx, item)" />
                                            </div>
                                        </div>
                                ...
                                <div class="commentItemBox" v-for="(item, index) in listData" :key="index">
                                    ...
                                    <div class="rightComment">
                                        ...
                                        <div class="commentContent" v-if="activeKey == '0'">
                                            ...
                                            <div class="commentContentItem picturesList" v-if="item.pictures.length">
                                                <img v-for="(ite, idx) in item.pictures" :key="idx" :src="ite.viewUrl"
                                                    class="img" @click="handlePreviewImg(ite, idx, item)" />
                                            </div>
                                        </div>
                                                ...
                                                <div class="commentItemBox"
                                                    ...
                                                    <div class="rightComment">
                                                        ...
                                                        <div class="commentBtn">
                                                            ...
                                                            <span class="commentBtn-item" title="点赞"
                                                                v-if="!item1.IsLike" @click="handleLike2(item1, true)">
                                                                <LikeOutlined /><span>{{ item1.NumOfLike || 0 }}</span>
                                                            </span>
                                                            <span class="commentBtn-item" title="取消点赞"
