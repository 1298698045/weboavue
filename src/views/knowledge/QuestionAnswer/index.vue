                    ...
                    <div class="panel-bd">
                        <div class="left-menu">
                            <div class="left-menu-item" :class="{'left-menu-item-active':data.selectmenu==1}" @click="changeMenu(1)">
                                <span class="left-menu-item-icon"><BarsOutlined /></span><span class="left-menu-item-label">全部问题</span>
                            </div>
                            <div class="left-menu-item" :class="{'left-menu-item-active':data.selectmenu==2}" @click="changeMenu(2)">
                                <span class="left-menu-item-icon"><UserOutlined /></span><span class="left-menu-item-label">我的问题</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panelQuestionAnswerWrap">
                            <div class="commentBox commentBox0">
                                ...
                                <div class="rightTextare">
                                    <textarea class="textarea" v-model="comment" placeholder-class="placeholder" placeholder="有什么问题需要解答？" name="" id="" cols="30" rows="10"></textarea>
                                </div> -->
                                <!-- <div class="tabContainer">
                                <a-tabs v-model:activeKey="activeKey">
                                    <a-tab-pane key="6000" tab="动态"></a-tab-pane>
                                    <a-tab-pane key="30400" tab="投票"></a-tab-pane>
                                    <a-tab-pane key="30401" tab="问题"></a-tab-pane>
                                </a-tabs>
                                </div> -->
                                <div class="TEditorWrap">
                                <TEditor
                                ref="editorRef"
                            ...
                            <div class="optionalWrap">
                                <a-button type="primary" @click="handleSendComment" :disabled="!data.comment">发布</a-button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panelQuestionAnswerWrap">
                            <div class="commentSearch">
                                <div class="wea-left-tree-search">
                                    <!-- <span class="wea-left-tree-search-label alltype">搜索问题：</span> -->
                                    <a-input
...
<script setup>
    ...
    import { UserOutlined,LikeOutlined,DeleteOutlined,ExportOutlined,MessageOutlined,BarsOutlined,MoreOutlined,SearchOutlined,LikeFilled,LoadingOutlined } from "@ant-design/icons-vue";
    ...
    const { activeKey,loading,typeitem,type,OwningUserName,listData1,selectmenu,keyIndex,listData, page, rows, total, comment,searchVal,isDelete,recordId,objectTypeCode,sObjectName,deleteDesc,external } = toRefs(data);
    const changeMenu=(e)=>{
        data.selectmenu=e;
        data.keyIndex=1;
        getCommentList();
    ...
    const handleSendComment = () => {
        if(data.comment==""){
            ...
            // });
            let url=Interface.question.submit;
                let d = {
                actions:[{
                    id: "2919;a",
                    descriptor: "",
    ...
    onMounted(() => {
        ...
        window.addEventListener(
            "scroll",
            function () {
            if (document.getElementsByClassName("QuestionAnswerWrap").length) {
            } else {
                return;
            }
            var clientHeight =
                document.getElementsByClassName("QuestionAnswerWrap")[0].clientHeight;
            var scrollTop =
                document.getElementsByClassName("QuestionAnswerWrap")[0].scrollTop;
            var scrollHeight =
                document.getElementsByClassName("QuestionAnswerWrap")[0].scrollHeight;
            if (
                scrollTop &&
                clientHeight &&
...
<style lang="less">
    .QuestionAnswerWrap{
        ...
        .panelQuestionAnswerWrap .commentList .commentItemBox{
            margin: 0;
    ...
    .QuestionAnswerWrap {
        ...
        .panelQuestionAnswerWrap .pagination{
