<template>
  <div class="todoList RuleArticleMyHome">
      ...
      <a-row>
        ...
        <a-col :span="isCollapsed ? '24' : '19'" class="wea-left-right-layout-right">
          ...
          <div style="height: 100%" ref="contentRef">
            ...
            <list-form-search ref="searchRef" @search="handleSearch" entityApiName="Institution" :SearchFields="SearchFields"
    ...
    <NewRuleArticle :isShow="isNew" v-if="isNew" :type="type" :id="listId" :FolderId="treeId" @ok="refreshList" @cancel="isNew=false" />
  </div>
</template>
<script setup>
  import {
  ...
  proxy.$get('/localData/treedata.json', {}).then((res) => {
    ...
    onExpand(['10010000-0000-0000-0000-000000007002']);
  ...
  const { isCollapsed, tableHeight, fieldNames, tabs, activeKey, isModal, isCirculation, searchVal,objectTypeCode,entityName,isDelete,listId,deleteDesc,external,
...
const getColumns = (id) => {
  let columnslist=[{
        ...
        },
        {
            ...
            <div class="option-item">催办</div>
            <div class="option-item">废止</div>  
            <div class="option-item">添加水印</div>
