...
const getQuery = () => {
  ...
  let d = {
    ...
    sort: 'CreatedOn',
    order: 'desc',
    displayColumns: 'Name,ObjectId,ReaderId,ReadOn,CreatedBy,CreatedOn,OwningUser'
  }
