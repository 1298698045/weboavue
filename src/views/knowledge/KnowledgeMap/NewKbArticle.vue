        ...
        <a-col span="5" class="wea-left-right-layout-left" v-if="!isCollapsed">
          <div class="wea-left-tree">
            <div class="wea-left-tree-select">
              ...
              >
                <a-select-option key="0" value="我的收藏"
                  >我的收藏</a-select-option
                >
                <a-select-option key="1" value="全部目录"
                  >全部目录</a-select-option
                >
              </a-select>
            </div>
                    ...
                    <span>
                      ...
                      <span class="tree-num">
                        <span
                          ...
                          :class="{
                            'tree-favor-active':
                              isFavor || data.leftTreeTop == '我的收藏',
                          }"
                          @click.stop="setFavor(id, name, quantity, isFavor)"
                        >
                          <StarOutlined
                            title="收藏"
                            v-if="!isFavor && data.leftTreeTop != '我的收藏'"
                          />
                          <StarFilled
                            title="取消收藏"
                            v-if="isFavor || data.leftTreeTop == '我的收藏'"
