        ...
        <div class="todoListWrap">
            ...
            <div class="rightContainer">
                ...
                <div class="head-right-breadcrumb">
                        <a-breadcrumb>
                          <a-breadcrumb-item><a href="javascript:void(0)" @click="tofolder('','')"><HomeOutlined style="margin-right: 5px;" /> 视频管理</a></a-breadcrumb-item>
...
<script setup>
    ...
    import { HomeOutlined,SearchOutlined, MoreOutlined, CopyOutlined, SortAscendingOutlined,LeftOutlined, RightOutlined, PlusOutlined, DownOutlined,FolderOutlined,ClockCircleOutlined,FolderViewOutlined,DeleteOutlined,StarOutlined,LoadingOutlined } from "@ant-design/icons-vue";
