        ...
        <a-row>
          ...
          <a-col :span="isCollapsed ? '24' : '19'" class="wea-left-right-layout-right">
            ...
            <div style="height: 100%" ref="contentRef">
              ...
              <list-form-search ref="searchRef" @search="handleSearch" :entityApiName="queryParams.entityName" :SearchFields="SearchFields"
  ...
  const getColumns = (id) => {
    ...
    const getTabs = () => {
      ...
      proxy.$get(Interface.getTabs, {
        ...
        if(res&&res.tabs&&res.tabs.length){
          ...
          data.tabs = data.tabs.concat(list);
        }
        else{
    ...
    const changeTab = (e) => {
        ...
        if(e==0||e==1){
            ...
            data.queryParams.objectTypeCode='100108';
        }else{
            data.queryParams.entityName='OfficialDocumentOut';
            data.queryParams.objectTypeCode='100109';
        }
        getColumns(data.queryParams.filterId);
    }
    // 添加分类
