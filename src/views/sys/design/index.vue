  ...
  <div class="designWrap">
    <div class="design">
          ...
          <div class="dropMenuWapper">
            <div class="layoutIconList">
              <div
                title="一列"
                class="img"
                :class="{ active: layoutType == 'A' }"
                @click.stop="choiceLayout('A')"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div
                title="两列"
                class="img"
                :class="{ active: layoutType == 'AA' }"
                @click.stop="choiceLayout('AA')"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div
                title="三列"
                class="img"
                :class="{ active: layoutType == 'AAA' }"
                @click.stop="choiceLayout('AAA')"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div
                title="左侧边栏"
                class="img"
                :class="{ active: layoutType == 'BA' }"
                @click.stop="choiceLayout('BA')"
              >
                <svg
                  width="24"
                  height="24"
              ...
              <div
                title="右侧边栏"
                class="img"
                :class="{ active: layoutType == 'AB' }"
                @click.stop="choiceLayout('AB')"
              >
                <svg
                  width="24"
                  height="24"
      ...
      <div class="designBody">
        ...
        <div class="itxst row">
          <div
            class="columnItem col-3"
            v-for="(self, selfIdx) in columns"
            :key="selfIdx"
          >
                ...
                <template #item="{ element, index }">
                  ...
                  >
                    <div class="panel">
                      <div class="panel-head">
                        <div class="panel-title" v-if="!element.isRename">
                          ...
                          >
                            <span
                              class="descNum"
                              v-if="element.componentType == 'tablist'"
                              >（{{
                            ...
                            <span class="descNum" v-else
                              >（{{
                                (element.dataList && element.dataList.length) ||
                                0
                              }}项）</span
                            >
                          </span>
                          ...
                          >
                            ...
                            >
                              <div class="dropMenu">
                                  ...
                                  <div class="colorsBox">
                                    ...
                                    >
                                      <svg
                                        ...
                                        role="presentation"
                                        v-if="
                                          element?.config?.color == colorItem
                                        "
                                      >
                                        <path
                                ...
                                <div
                                  class="dropMenuItem"
                                  v-if="element.componentType != 'calendar'"
                                  @click="
                                    handleRowConfig(element, selfIdx, index)
                                  "
                                >
                          ...
                          <div class="scheduleBody canlendartablist">
                            <div class="tabContainer">
                              <div class="tabList">
                                <div
                                  class="tab"
                                  :class="{ active: element.currentTab == 0 }"
                                ...
                                <div
                                  class="tab"
                                  :class="{ active: element.currentTab == 1 }"
                                ...
                                <div
                                  class="tab"
                                  :class="{ active: element.currentTab == 2 }"
                      ...
                      <div
                        class="panel-bd"
                        v-else-if="element.componentType == 'swiper'"
                      >
                        <a-carousel
                          v-if="!element.isConfig"
                          dots-class="slick-dots slick-thumb"
                          autoplay
                        >
                          <div
                            v-for="(listItem, listitemIdx) in element.list"
                            :key="listitemIdx"
                          >
                      ...
                      <!-- 常用链接 -->
                      <div
                        class="panel-bd oftenLinkBody"
                        v-else-if="element.componentType == 'text-grid'"
                      >
                        <div class="oftenLinkList">
                          <div
                            class="oftenLinkItem"
                            v-for="listItem in element.dataList"
                      ...
                      <div
                        class="panel-bd"
                        v-else-if="element.componentType == 'icon-grid'"
                      >
                        <div class="oftenLinkList">
                          <div
                            class="oftenLinkItem oftenLinkItem1"
                            v-for="listItem in element.dataList"
                            @click="gotoMoreUrl(listItem.LinkUrl)"
                          >
                      ...
                      >
                        ...
                        >
                          <div v-if="element.dataList.length > 0">
                            <li
                              class="listItem isFixed"
                              v-if="
                                element.listColumns != '' && element.showHeader
                              "
                            >
                              <span
                                v-for="child in element.listColumns &&
                                element.listColumns"
                                >{{ child.label }}</span
                              >
                            </li>
                            <li
                              class="listItem"
                              v-for="child in element.dataList"
                            ...
                            >
                              ...
                              >
                                <span
                                  v-for="cell in element.listColumns &&
                                  element.listColumns"
                                >
                                  <span v-if="cell.field == 'IsTop'">
                                    <button
                                      class="btnTag tagWarning"
                              ...
                              <template v-else>
                                <span
                                  v-for="(cell, key, cellIdx) in child"
                                  v-if="key != 'ID' && key != 'LIST_RECORD_ID'"
                                  >{{ cell }}</span
                                >
                              </template>
                            </li>
                      ...
                      <div
                        class="panel-bd"
                        v-else-if="element.componentType == 'tablist'"
                      >
                        <div v-if="!element.isConfig">
                          <div>
                            <div class="tabContainer flex">
                              <div class="tabList">
                                <div
                                  class="tab"
                                  :class="{
                                    active: element.currentTab == tabIdx,
                                  }"
                                  ...
                                  <template #content>
                                    <a-form>
                                      <a-form-item label="标签名称">
                                        <a-input
                                          v-model:value="element.addTagName"
                                        ></a-input>
                                      </a-form-item>
                                      <a-form-item label="对象代码">
                                        <a-select
                                          v-model:value="element.addObjCode"
                                          placeholder="请选择对象代码"
                                        >
                                          <a-select-option
                                            v-for="(
                          ...
                          >
                            <ul
                              class="listWrap"
                              v-if="element.currentTab == tabIdx"
                            >
                              <div v-if="tab.listComponent.dataList.length > 0">
                                <li
                                  class="listItem listItemHead"
                                  v-if="
                                ...
                                >
                                  <p
                                    class="listItemTitle"
                                    v-for="child in tab.listComponent
                                      .listColumns"
                                  >
                                    <span
                                      v-if="
                                ...
                                <li
                                  class="listItem tablistItem"
                                  v-for="child in tab.listComponent.dataList"
                                  @click="
                                    handleRowDetail(element.detailUrl, listItem)
                                  "
                                >
                                  <template
                                    v-if="tab.listComponent.displayColumns"
                                  >
                                    <template
                                      v-for="(cell, index) in tab.listComponent
                                        .displayColumns &&
                                    ...
                                    >
                                      ...
                                      <p
                                        v-else-if="cell == 'BusinessUnitIdName'"
                                        class="listItemDept"
                                      >
                                        {{ child[cell] }}
                                      </p>
                      ...
                      <div
                        class="panel-bd"
                        v-else-if="element.componentType == 'chart'"
                      >
                        <div class="chartWrap" v-if="!element.isConfig">
                          <div
                            :id="'showChart_' + selfIdx + '_' + index"
                        ...
                        <ChartConfig
                          ...
                          :index="selfIdx"
                          :itemIdx="index"
                          @cancel="handleRowConfig(element, selfIdx, index)"
                          v-else
                        ></ChartConfig>
                      </div>
                    </div>
            ...
            <template #item="{ element, index }">
              <div class="templateItem">
                <div class="itemLeft">
                  ...
                  <a-button type="primary" @click="handleAddLeft(element)"
                    >添加</a-button
                  >
                </div>
                <div class="itemRight">
