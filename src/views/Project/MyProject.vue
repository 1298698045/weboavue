        ...
        <a-col :span="isCollapsed ? '24' : '24'" class="wea-left-right-layout-right">
          ...
          <div style="height: 100%" ref="contentRef">
            ...
            <div class="statistics">
                    ...
                    <div class="statisticItem">
                        <div class="statisticLeft">
                            <div class="statisticName">前期项目</div>
                    ...
                    <div class="statisticItem">
                        <div class="statisticLeft">
                            <div class="statisticName">执行中项目</div>
                            <div class="statisticCount">{{statistics.RefundAmount || 0}}</div>
                        </div>
                        <div class="statisticRight">
                            <p class="icon">
                    ...
                    <div class="statisticItem">
                        <div class="statisticLeft">
                            <div class="statisticName">已完成项目</div>
                            <div class="statisticCount">{{statistics.RefundAmount || 0}}</div>
                        </div>
                        <div class="statisticRight">
                            <p class="icon">
                              <CheckCircleOutlined style="color: #31BA6A;" />
                            </p>
                        </div>
                    </div>
                    <div class="statisticItem">
        ...
        if(item.name=='Name'){
          columnslist.push({
            ...
            formatter: function formatter(value, row, index) {
              ...
              return '<a style="color:#1677ff;text-decoration: none;" href="/#/lightning/r/Project/detail?id='+vid+'&type=mine" target="_blank">'+result+'</a>';
            }
          });
        }
