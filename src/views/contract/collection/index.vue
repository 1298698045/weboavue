    ...
    <div class="todoList">
        <div class="headerBar">
            <div class="headerLeft">
                ...
                <span class="headerTitle">收款管理</span>
            </div>
            <div class="headerRight">
                <a-button type="primary" class="ml10">新建到款记录</a-button>
            </div>
        </div>
...
<script setup>
    ...
    import useCollection from "@/utils/contract/collection";
    const { tabList } = useCollection();
