    ...
    <div class="groupDetail">
        <div class="header">
            ...
            <div class="rightBtns">
                ...
                <a-button class="ml10" type="primary">编辑成员</a-button>
                <a-button class="ml10">删除小组</a-button>
                    ...
                    <div class="rightAside">
                        <div class="panel">
                            <div class="panel-head">
                                ...
                                <div class="panel-btn">
                                    <a-button type="text" size="small">添加管理员</a-button>
                                </div>
                            </div>
                            <div class="panel-bd">
                        ...
                        <div class="panel">
                            <div class="panel-head">
                                ...
                                <div class="panel-btn">
                                    <a-button type="text" size="small">添加成员</a-button>
                                </div>
                            </div>
                            <div class="panel-bd">
                                <div class="relevantList">
...
<script setup>
    ...
    const { activeKey, adminList, peopleList } = toRefs(data);
    const getAdminData = () => {
