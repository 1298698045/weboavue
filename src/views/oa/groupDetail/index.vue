        ...
        <div class="header">
            ...
            <div class="rightBtns">
                ...
                <a-dropdown :trigger="['hover']" class="ml10">
                    ...
                    <template #overlay>
                        <a-menu>
                            <a-menu-item key="1" @click="handleOpenNotes">
                                备注
                            </a-menu-item>
                        </a-menu>
                    </template>
                    ...
                    <div class="rightAside">
                        <div class="panel">
                            <div class="panel-head">
                                ...
                                <div class="panel-btn">
                                    <a-button type="text" size="small" @click="handleAddAdmin">添加管理员</a-button>
                                </div>
                            </div>
                            <div class="panel-bd">
                                <div class="relevantList">
                                    <div class="people-head-list">
                                        <div class="peopleItem" v-for="(item,index) in adminList" :key="index">
                                            <div class="editheadbg"></div>
                                            <img :src="require('@/assets/img/avatar.png')" alt="" class="d-avatar">
                                            <div :title="item.FullName" class="relevantTitle">{{item.FullName}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-head">
                                ...
                                <div class="panel-btn">
                                    <a-button type="text" size="small" @click="handleAddPeople">添加成员</a-button>
                                </div>
                            </div>
                            <div class="panel-bd">
                                <div class="relevantList">
                                    <div class="people-head-list">
                                        <div class="peopleItem" v-for="(item,index) in peopleList" :key="index">
                                            <div class="editheadbg"></div>
                                            <img :src="require('@/assets/img/avatar.png')" alt="" class="d-avatar">
                                            <div :title="item.FullName" class="relevantTitle">{{item.FullName}}</div>
                                        </div>
...
<script setup>
    ...
    const { activeKey, adminList, peopleList, isRadioUser, isNotes, isDelete, isAdmin } = toRefs(data);
    ...
    const getUserData = (params) => {
        ...
        if(!data.isAdmin){
            proxy.$get(Interface.group.addPeople,{
