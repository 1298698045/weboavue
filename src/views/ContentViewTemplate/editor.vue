                                  ...
                                  <div style="border-left: 1px solid rgb(228, 228, 228);">
                                    <div style="padding: 4px 7px 6px; border-bottom: 1px solid rgb(228, 228, 228);">
                                      <div class="wea-input-focus ">
                                        ...
                                        <button type="button" class="ant-btn ant-btn-ghost ant-btn-icon-only  wea-input-focus-btn">
                                          <SearchOutlined />
                                        </button>
                                    ...
                                    <div class="special-field-wrapper-single ">
                                      <div class="wea-new-scroll " style="height: 497px;">
                                        <div class="clipper  baron" style="overflow: hidden;">
                                          <div class="scroller  " style="overflow-y: scroll; box-sizing: border-box; margin: 0px; border: 0px;">
                                            <ul style="padding: 7px 0px;">
                                              <li class="special-field-item text-overflow" v-for="(item,index) in FieldList" :name="item.name" :key="index" :class="{'actived':SelectFieldId==item.id}" @click="SelectField(item)">{{item.label||''}}</li>
                                            </ul>
                                          </div>
                                          <div class="track ">
